  ...
  class SDSClient
    ...
    def perform_multipart_upload(path, file_path)
      ...
      when 200
        body
      when 400
        raise SDSErrorResponse, "The request is bad, e.g. fail to upload the file to serialization_data_server."
      when 403
      ...
      when 501
        raise SDSErrorResponse, "Serialized data file is regonized, but file not found in serialization_data_server."
      else
