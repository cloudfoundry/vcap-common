...
describe VCAP::Services::Api::ServiceGatewayClient do
  describe '#perform_request' do
    ...
    it "should should raise error with none 200 response" do
      ...
      expect {client.perform_request(http_method, path)}.to raise_error(VCAP::Services::Api::ServiceGatewayClient::NotFoundResponse)
      expect {client.perform_request(http_method, path)}.to raise_error(VCAP::Services::Api::ServiceGatewayClient::GatewayInternalResponse)
      expect {client.perform_request(http_method, path)}.to raise_error(VCAP::Services::Api::ServiceGatewayClient::ErrorResponse, /not done yet/)
      expect {client.perform_request(http_method, path)}.to raise_error(VCAP::Services::Api::ServiceGatewayClient::UnexpectedResponse)
    end
  end
end
